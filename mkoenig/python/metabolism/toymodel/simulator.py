...
def simulate_manual(fba_sbml, comp_ode_sbml, tend=10.0, step_size=0.01, debug=True):
    """
    Performs the manual model integration.

    Manual connection of the fba model and the combined comp_ode model.
    The connections are hard coded.
    Proof-of-principle.
    The general simulate figures out the replacement and which information to pass between
    submodels.
    ...
    while time <= tend:
        ...
        cobra_R1.upper_bound = rr_comp.bounds__ub_R1
...
if __name__ == "__main__":
    ...
    from settings import top_level_file
    ...
    if 0:
        ...
        df1.plot(x='time', y=['update__R1',
                              'update__R2',
                              'update__R3',
                              'model__R4'])
        df1.plot(x='time', y=['[update__A]',
                              '[update__B1]',
                              '[update__B2]',
                              '[C]',
                              '[model__D]'])
