...
classdef  Metabolism < edu.stanford.covert.cell.sim.ReactionProcess
    ...
    methods
        ...
        function evolveState(this)
            ...
            input = struct;
            input.cellDryMass = sum(this.mass.cellDry);
            input.substrates = this.substrates;
            input.enzymes = this.enzymes;
            
            [fluxBounds, fbdata] = this.calcFluxBounds(this.substrates, this.enzymes, this.fbaReactionBounds, this.fbaEnzymeBounds);
            
            % save data 
            save('/home/mkoenig/wholecell-metabolism/mkoenig/data/matlab_dumps/input.mat', '-struct', 'input')
            save('/home/mkoenig/wholecell-metabolism/mkoenig/data/matlab_dumps/fluxbounds.mat', '-struct', 'fbdata')
            clear input
            clear fbdata
            
            % create all workspace variables
            field_names = fields(this);
            for k=1:length(field_names)
                fname = field_names{k};
            eval([fname, ' = this.(fname);'])
            end
            save('/home/mkoenig/wholecell-metabolism/mkoenig/data/matlab_dumps/this.mat')
            a = 1;
            
            [this.metabolicReaction.growth, this.metabolicReaction.fluxs, fbaReactionFluxs] = this.calcGrowthRate(fluxBounds);
    ...
    methods
        ...
        function [bounds, fbdata] = calcFluxBounds(this, substrates, enzymes, fbaReactionBounds, fbaEnzymeBounds, ...
            ...
            % store input
            fbdata = struct;
            fbdata.substrates = substrates;
            fbdata.enzymes = enzymes;
            fbdata.fbaReactionBounds = fbaReactionBounds;
            fbdata.fbaEnzymeBounds = fbaEnzymeBounds;
            ...
            fbdata.rxnEnzymes = rxnEnzymes;
            fbdata.lowerBounds_applyEnzymeKineticBounds = lowerBounds;
            fbdata.upperBounds_applyEnzymeKineticBounds = upperBounds;
            ...
            fbdata.lowerBounds_applyEnzymeBounds = lowerBounds;
            fbdata.lowerBounds_applyEnzymeBounds = upperBounds;
            ...
            fbdata.lowerBounds_applyDirectionalityBounds = lowerBounds;
            fbdata.lowerBounds_applyDirectionalityBounds = upperBounds;
            
            fbdata.cellDryMass = sum(this.mass.cellDry);
            ...
            fbdata.lowerBounds_applyExternalMetaboliteBounds = lowerBounds;
            fbdata.lowerBounds_applyExternalMetaboliteBounds = upperBounds;
            ...
            fbdata.lowerBounds_applyInternalMetaboliteBounds = lowerBounds;
            fbdata.lowerBounds_applyInternalMetaboliteBounds = upperBounds;
            ...
            fbdata.lowerBounds_applyProteinBounds = lowerBounds;
            fbdata.lowerBounds_applyProteinBounds = upperBounds;
